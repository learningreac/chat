...
const ChatSlider = ({ isRetracted, handleToggle, friendslist,setChatee,chatee }) => {
  ...
  return (
    <div className="spa-chat" ref={sliderRef} style={{ height: sliderheight }}>
      ...
      <ChatCloser />
      <Sizer sizerheight={sizerheight} friendslist={friendslist} setChatee={setChatee}chatee={chatee} />
    </div>
  )
};
